        ...
        <div className="stories-top">
          ...
          <Cardapi 
              ...
              {/* <div className="stories1">
                ...
                <div className="money">
                  <h5>FINANCE</h5>
                  <p className="money-responsive">
                    DSG Consumer Partners likely to raise nearly $125 mn for new
                    fund
                  </p>
                  <p className="money-responsive1">
                    <span>30 sept</span>
                    <span>Madhiruma Nandy,Madhiruma Nandy</span>
                  </p>
                </div>
              </div>
              <div className="stories1">
          ...
          <div className="stories-top">
            <div className="stories stories-responsive">
              ...
              <div className="stories-left">
                <div className="stories1">
                  <div>
                    <img src="./images/infrastr.png" alt="" />
                  </div>
                  <div className="money">
                    <h5>INFRASTUCTURE</h5>
                    <p className="money-responsive">
                ...
                <div className="stories1">
                  <div>
                    <img src="./images/buildpipe.png" alt="" />
                  </div>
                  <div className="money">
                    <h5>FINANCE</h5>
                    <p className="money-responsive">
